          ...
          <form onSubmit={this.handleEdit}>
            <div className="agendCtrls-label-wrapper">
              <div className="agendCtrls-label-inline">
                <label>Outil 1</label>
                <select name="tool1" ref="eventName" className="agendCtrls-event-input" /*value={this.state.name}*/ onChange={this.handleChange.bind(this)}>
              ...
              <div className="agendCtrls-label-inline ">
                <label>Outil 2</label>
                <select name="tool2" ref="eventName" className="agendCtrls-event-input" /*value={this.state.name}*/ onChange={this.handleChange.bind(this)}>
                  <option value="un">un</option>
                  <option value="deux">deux</option>
                  <option value="trois">trois</option>
                </select>
      ...
      <div className="agendCtrls-wrapper" style={divStyle}>
        <form onSubmit={this.handleSubmit}>
          <div className="agendCtrls-label-wrapper">
            <div className="agendCtrls-label-inline">
              <label>Outil 1</label>
              <select ref="eventName" name="tool1" className="agendCtrls-event-input" /*value={this.state.name}*/ onChange={this.handleChange.bind(this)}>
                <option value="un">un</option>
                <option value="deux">deux</option>
                <option value="trois">trois</option>
              </select>
            ...
            <div className="agendCtrls-label-inline">
              <label>Outil 2</label>
              <select ref="eventName" name="tool2" className="agendCtrls-event-input" /*value={this.state.name}*/ onChange={this.handleChange.bind(this)}>
                <option value="un">un</option>
                <option value="deux">deux</option>
                <option value="trois">trois</option>
              </select>
